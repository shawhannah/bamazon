    ...
    .prompt([
      {
        ...
        type: "input",
        message:
          "What is the ID of the product that works best for you? [Changed your mind? Press Y]"
      },
      {
        name: "qty",
        type: "input",
        message:
          "You will claim your write-off later, so how many of this product did you have in mind?"
      }
    ])
